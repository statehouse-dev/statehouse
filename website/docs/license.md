...
This software is **free to use**, including in production, under the terms below.
...
Additional commercial editions (e.g. Pro, Enterprise) may be offered in the future.
These editions may include additional features, services, or support.
...
1. **Free for users**: You can use it in production without paying
2. **Protection from competition**: Prevents others from offering Statehouse as a service
3. **Sustainable development**: Enables future commercial editions to fund development
